    ...
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<Tuple<UserSetUp, bool>> CreateAsync(UserSetUp user)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("p_date_of_birth", user.DateOfBirth ?? (object)DBNull.Value);
                ...
                cmd.Parameters.AddWithValue("p_locked_time", user.LockedTime ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("p_created_by", user.CreatedBy ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("p_modified_by", user.ModifiedBy ?? (object)DBNull.Value);
                ...
                if (!error)
                {
                    user.UserId = (short)cmd.Parameters["p_out_user_id"].Value;
                }
